...
min(bb_train$RelSpeed)
max(bb_train$RelSpeed)
min(bb_train$InducedVertBreak)
max(bb_train$InducedVertBreak)
min(bb_train$SpinRate)
max(bb_train$SpinRate)
min(bb_train$HorzBreak)
max(bb_train$HorzBreak)
